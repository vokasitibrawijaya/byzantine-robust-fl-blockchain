...
\begin{itemize}
    \item \textbf{Code Repository:} Complete implementation available at \url{https://github.com/vokasitibrawijaya/byzantine-robust-fl-blockchain}, including:
    \begin{itemize}
...
\textbf{Testnet Deployment Plan:} We have prepared complete deployment infrastructure for Sepolia (L1) and Arbitrum Sepolia (L2) testnets. Contract address: \texttt{0x66Cd2b58094268CCfb162de8C8DCF5C0B9d58d17}. Deployment requires 0.5 ETH testnet funding (available via faucets). See supplementary materials for deployment scripts and faucet instructions.
